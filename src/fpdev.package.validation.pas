...
begin
  ...
  begin
    AddMessage(vlError, _(CMD_PKG_VALIDATE_PKGJSON_NOT_FOUND));
    Exit;
  end;
  ...
  try
    ...
    try
      ...
      begin
        J.Free;
        AddMessage(vlError, _(CMD_PKG_VALIDATE_PKGJSON_NOT_JSON));
      end;
    finally
      FS.Free;
    end;
    ...
    on E: Exception do
    begin
      AddMessage(vlError, _Fmt(CMD_PKG_VALIDATE_PKGJSON_LOAD_FAILED, [E.Message]));
      Result := False;
    end;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        AddMessage(vlError, _Fmt(CMD_PKG_VALIDATE_REQUIRED_FIELD_MISSING, [FieldName]));
      end;
    end;
    ...
    begin
      ...
      begin
        AddMessage(vlError, _Fmt(CMD_PKG_VALIDATE_VERSION_INVALID, [Version]));
      end;
    end;
...
begin
  ...
  try
    ...
    begin
      AddMessage(vlInfo, _(CMD_PKG_VALIDATE_FILES_NOT_SPECIFIED));
      Result := True;
      Exit;
    end;
    ...
    begin
      AddMessage(vlWarning, _(CMD_PKG_VALIDATE_FILES_EMPTY));
      Result := True;
      Exit;
    end;
    ...
    begin
      ...
      begin
        AddMessage(vlError, _Fmt(CMD_PKG_VALIDATE_FILE_NOT_FOUND, [FileName]));
      end;
    end;
...
begin
  ...
  try
    ...
    begin
      AddMessage(vlInfo, _(CMD_PKG_VALIDATE_DEPS_NOT_SPECIFIED));
      Result := True;
      Exit;
    end;
    ...
    begin
      AddMessage(vlInfo, _(CMD_PKG_VALIDATE_DEPS_EMPTY));
      Result := True;
      Exit;
    end;
    ...
    begin
      ...
      begin
        AddMessage(vlError, _Fmt(CMD_PKG_VALIDATE_DEP_VERSION_INVALID, [DepName, DepVersion]));
      end;
    end;
...
begin
  ...
  begin
    AddMessage(vlError, _(CMD_PKG_VALIDATE_LICENSE_NOT_FOUND));
    Exit;
  end;

  AddMessage(vlInfo, _(CMD_PKG_VALIDATE_LICENSE_FOUND));
  Result := True;
end;
...
begin
  ...
  begin
    AddMessage(vlWarning, _(CMD_PKG_VALIDATE_README_NOT_FOUND));
  end
  else
  begin
    AddMessage(vlInfo, _(CMD_PKG_VALIDATE_README_FOUND));
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        AddMessage(vlError, _Fmt(CMD_PKG_VALIDATE_SENSITIVE_FILE, [FileName]));
      end;
    end;
...
begin
  ...
  begin
    case FMessages[I].Level of
      vlError: Prefix := _(CMD_PKG_VALIDATE_PREFIX_ERROR);
      vlWarning: Prefix := _(CMD_PKG_VALIDATE_PREFIX_WARNING);
      vlInfo: Prefix := _(CMD_PKG_VALIDATE_PREFIX_INFO);
    end;
