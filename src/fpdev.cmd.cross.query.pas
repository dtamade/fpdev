unit fpdev.cmd.cross.query;

{
================================================================================
  fpdev.cmd.cross.query - Cross-compilation Target Query Helper
================================================================================
...
constructor TCrossTargetQuery.Create(AConfigManager: IConfigManager; AResourceRepo: TResourceRepository; const AInstallRoot: string);
begin
  inherited Create;
