...
[![Tests](https://img.shields.io/badge/tests-353%20discoverable-brightgreen.svg)](#testing)
...
[INFO] Discoverable test programs: 353 (same inventory rules as CI)
...
fpdev cross install x86_64-win64      # 安装交叉编译目标
...
总计: 353 个可发现的 test_*.lpr 测试程序（与 CI 使用同一发现规则）
