...
[![Tests](https://img.shields.io/badge/tests-346%20discoverable-brightgreen.svg)](#testing)
...
[INFO] Discoverable test programs: 346 (same inventory rules as CI)
...
总计: 346 个可发现的 test_*.lpr 测试程序（与 CI 使用同一发现规则）
